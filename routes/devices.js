...
deviceRouter
  .route('/owned')
  .get(validatorFn, tryCatchWrapper(DeviceService.getOwnedDevices));
deviceRouter
  .route('/instock')
  .get(validatorFn, tryCatchWrapper(DeviceService.getInStockDevices));
deviceRouter
  .route('/assign')
...
deviceRouter
  .route('/:id')
  .get(validatorFn, tryCatchWrapper(DeviceService.getDevice));
